...
function getSettingsSchema() {
  ...
  return [
    ...
    {
      key: "autoWcDumpsEnabled",
      type: "boolean",
      default: false,
      section: "Tools",
      group: "Diagnostics",
      groupOrder: 7,
      label: "Auto-save WC debug snapshots",
      help: "Keeps a rotating set of working-copy snapshots in kitchen/debug_dumps (for diagnostics).",
      ui: { input: "checkbox" },
      advanced: true,
    },
    {
      key: "autoWcDumpsLimit",
      type: "number",
      default: 12,
      section: "Tools",
      group: "Diagnostics",
      groupOrder: 8,
      label: "WC snapshot limit",
      help: "How many auto snapshots to keep (rotating).",
    ...
    },
    {
      ...
      groupOrder: 30,
      label: "Beep on input",
      help: "Play a short beep for each incoming MIDI note.",
      ui: { input: "checkbox" },
      advanced: true,
    },
    {
      ...
      groupOrder: 30,
      label: "Beep volume (%)",
      help: "Volume for MIDI input beeps (0–100%).",
      ui: { input: "percent", min: 0, max: 100, step: 5 },
      advanced: true,
    },
    {
      ...
      group: "MIDI Input",
      groupOrder: 30,
      label: "Beep duration (ms)",
      help: "Duration of MIDI input beeps (40–400ms).",
