...
const FALLBACK_SCHEMA = [
  ...
  { key: "stripImportedMeasureComments", type: "boolean", default: true, section: "Tools", group: "Import/Export", groupOrder: 20, label: "Remove imported measure comments", help: "Remove xml2abc comments such as %7 and %14 from imported ABC text.", ui: { input: "checkbox" }, advanced: true },
  { key: "autoFormatImportedAbc", type: "boolean", default: true, section: "Tools", group: "Import/Export", groupOrder: 20, label: "Auto-format imported ABC", help: "Apply the standard ABCarus line-break and bar alignment pass after import.", ui: { input: "checkbox" }, advanced: true },
