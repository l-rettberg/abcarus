...
const FALLBACK_SCHEMA = [
  ...
  { key: "midiInputBeepEnabled", type: "boolean", default: false, section: "Tools", group: "MIDI Input", groupOrder: 30, label: "Beep on input", ui: { input: "checkbox" }, advanced: true },
  { key: "midiInputBeepVolume", type: "number", default: 0.2, section: "Tools", group: "MIDI Input", groupOrder: 30, label: "Beep volume (%)", ui: { input: "percent", min: 0, max: 100, step: 5 }, advanced: true },
  { key: "midiInputBeepDuration", type: "number", default: 140, section: "Tools", group: "MIDI Input", groupOrder: 30, label: "Beep duration (ms)", ui: { input: "number", min: 40, max: 400, step: 10 }, advanced: true },
